...
$query="SELECT * FROM soldier ORDER BY dateadded DESC";  // sorts the data base in descending order by date putting first added at the top 
...
<head>
    <title>Fallen of Lanarkshire - Search</title>
    <meta charset="utf-8">
    ...
    <div style="background-color:#659ed3" class="container">
        <div class="row justify-content-center">
            <div class="class-help col-lg-12 col-md-12 col-sm-12 m-4 p-4">
                <h2 class="feature-title-five text-center">8 Latest added</h2>
            ...
            <?php
                $count = 0;
            while ($count <= 7 && $row=mysqli_fetch_array($result)){   // displays last 8 records that were added to the database
                $id=$row['id'];
                $surname=$row['surname'];	
        ...
        ?>
                ...
                <div style="background-color:#f2f2f2" class="class-help col-lg-3 col-md-3 col-sm-12 bg-light m-4 p-4 shadow rounded">
