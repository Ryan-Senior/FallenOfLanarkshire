...
if(isset($_POST['search'])){
    ...
    $query="SELECT * FROM soldier WHERE town like '%$escapedsearchterm%'";
...
<head>
    <title>Fallen of Lanarkshire - Search Town</title>
    <meta charset="utf-8">
    ...
    <div style="background-color:#659ed3" class="container">
        ...
        <div class="row justify-content-center">
            <div class="class-help col-lg-12 col-md-12 col-sm-12 m-4 p-4">
                <h2 class="feature-title-five text-center">Rank Results</h2>
