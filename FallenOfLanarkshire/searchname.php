...
if(isset($_POST['search'])){
    ...
    $query="SELECT * FROM soldier WHERE forenames like '%$escapedsearchterm%' OR surname like '%$escapedsearchterm%'";
    ...
    <div style="background-color:#659ed3" class="container">
        ...
        <div class="row justify-content-center">
            <div class="class-help col-lg-12 col-md-12 col-sm-12 m-4 p-4">
                <h2 class="feature-title-five text-center">Name Results</h2>
